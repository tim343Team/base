package tim.com.libnetwork.view.pickerview.view;
...
import tim.com.libnetwork.view.pickerview.configure.PickerOptions;
import tim.com.libnetwork.view.pickerview.listener.ISelectTimeCallback;
import tim.com.libnetwork.view.pickerview.view.BasePickerView;
import tim.com.libnetwork.view.pickerview.view.WheelTime;
...
public class TimePickerView extends BasePickerView implements View.OnClickListener {
    ...
    private tim.com.libnetwork.view.pickerview.view.WheelTime wheelTime; //自定义控件
    ...
    private void initWheelTime(LinearLayout timePickerView) {
        wheelTime = new tim.com.libnetwork.view.pickerview.view.WheelTime(timePickerView, mPickerOptions.type, mPickerOptions.textGravity, mPickerOptions.textSizeContent);
        if (mPickerOptions.timeSelectChangeListener != null) {
            wheelTime.setSelectChangeCallback(new ISelectTimeCallback() {
                @Override
                public void onTimeSelectChanged() {
                    try {
                        Date date = tim.com.libnetwork.view.pickerview.view.WheelTime.dateFormat.parse(wheelTime.getTime());
